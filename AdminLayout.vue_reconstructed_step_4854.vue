...
<SidebarProvider>
<div
class="flex h-screen w-full bg-slate-100 overflow-hidden p-4 lg:p-6 gap-4 lg:gap-6"
>
<AppSidebar />
48:             <SidebarInset
class="flex flex-col h-full min-h-0 min-w-0 ov
<DropdownMenuItem
@click="handleLogout"
...
157:                 <!-- Page Content -->
<div
class="flex-1 overflow-auto bg-slate-50/50 p-4 sm:p-6 lg:p-10"
>
